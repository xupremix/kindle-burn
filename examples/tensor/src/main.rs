...
fn main() {
    ...
    // > = Tensor3 {
    //     tensor: kindle_burn::tensor::Tensor::<Autodiff<Fusion<Wgpu>>, 3>::zeros(
    //         Shape::new([2; 3]),
    ...
    // let t_gpu: Tensor3<Autodiff<Candle>, CandleCpuDevice, 2, 2, 2, kindle_burn::tensor::Float> =
    //     Tensor3 {
    //         tensor: kindle_burn::tensor::Tensor::<Autodiff<Candle>, 3>::zeros(
    //             Shape::new([2; 3]),
